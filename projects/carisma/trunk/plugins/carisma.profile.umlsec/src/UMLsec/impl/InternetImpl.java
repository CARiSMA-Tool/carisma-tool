...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Internet</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link UMLsec.impl.InternetImpl#getBase_CommunicationPath <em>Base Communication Path</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InternetImpl extends MinimalEObjectImpl.Container implements Internet {
	/**
	...
	protected EClass eStaticClass() {
		return UMLsecPackage.Literals.INTERNET;
	}
		...
		if (base_CommunicationPath != null && base_CommunicationPath.eIsProxy()) {
			...
			if (base_CommunicationPath != oldBase_CommunicationPath) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, UMLsecPackage.INTERNET__BASE_COMMUNICATION_PATH, oldBase_CommunicationPath, base_CommunicationPath));
			}
		}
	...
	public void setBase_CommunicationPath(CommunicationPath newBase_CommunicationPath) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UMLsecPackage.INTERNET__BASE_COMMUNICATION_PATH, oldBase_CommunicationPath, base_CommunicationPath));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case UMLsecPackage.INTERNET__BASE_COMMUNICATION_PATH:
