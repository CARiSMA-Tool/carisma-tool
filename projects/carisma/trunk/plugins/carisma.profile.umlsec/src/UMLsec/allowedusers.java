 ...
 * </p>
 * <ul>
 *   <li>{@link UMLsec.allowedusers#getBase_Action <em>Base Action</em>}</li>
 *   <li>{@link UMLsec.allowedusers#getUsers <em>Users</em>}</li>
 * </ul>
 *
 * @see UMLsec.UMLsecPackage#getallowedusers()
...
public interface allowedusers extends EObject {
	 ...
	 * @see UMLsec.UMLsecPackage#getallowedusers_Base_Action()
	...
	/**
	 * Sets the value of the '{@link UMLsec.allowedusers#getBase_Action <em>Base Action</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see UMLsec.UMLsecPackage#getallowedusers_Users()
