 ...
 * </p>
 * <ul>
 *   <li>{@link UMLsec.guarded#getBase_Classifier <em>Base Classifier</em>}</li>
 *   <li>{@link UMLsec.guarded#getBase_InstanceSpecification <em>Base Instance Specification</em>}</li>
 *   <li>{@link UMLsec.guarded#getGuard <em>Guard</em>}</li>
 * </ul>
 *
 * @see UMLsec.UMLsecPackage#getguarded()
 * @model
 * @generated
 */
public interface guarded extends EObject {
	 ...
	 * @see UMLsec.UMLsecPackage#getguarded_Base_Classifier()
	...
	/**
	 * Sets the value of the '{@link UMLsec.guarded#getBase_Classifier <em>Base Classifier</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see UMLsec.UMLsecPackage#getguarded_Base_InstanceSpecification()
	 * @model required="true" ordered="false"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link UMLsec.guarded#getBase_InstanceSpecification <em>Base Instance Specification</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see UMLsec.UMLsecPackage#getguarded_Guard()
