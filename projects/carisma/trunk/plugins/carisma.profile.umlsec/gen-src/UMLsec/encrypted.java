 ...
 * </p>
 * <ul>
 *   <li>{@link UMLsec.encrypted#getBase_CommunicationPath <em>Base Communication Path</em>}</li>
 * </ul>
 *
 * @see UMLsec.UMLsecPackage#getencrypted()
 * @model
 * @generated
 */
public interface encrypted extends EObject {
	 ...
	 * @see UMLsec.UMLsecPackage#getencrypted_Base_CommunicationPath()
	...
	/**
	 * Sets the value of the '{@link UMLsec.encrypted#getBase_CommunicationPath <em>Base Communication Path</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
