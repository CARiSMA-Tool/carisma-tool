...
import UMLsec.Internet;
import UMLsec.POSdevice;
import UMLsec.SAPTransaction;
import UMLsec.UMLsecFactory;
import UMLsec.UMLsecPackage;
import UMLsec.allowedusers;
import UMLsec.authorizedstatus;
import UMLsec.call;
import UMLsec.critical;
import UMLsec.datasecurity;
import UMLsec.encrypted;
import UMLsec.fairexchange;
import UMLsec.guarded;
import UMLsec.guardedaccess;
import UMLsec.high;
import UMLsec.identifiable;
import UMLsec.integrity;
import UMLsec.issuernode;
...
import UMLsec.rbac;
import UMLsec.requires;
import UMLsec.secrecy;
import UMLsec.securedependency;
import UMLsec.securelinks;
import UMLsec.send;
import UMLsec.seperationofduty;
import UMLsec.smartcard;
import UMLsec.usedby;
import UMLsec.wire;
...
public class UMLsecPackageImpl extends EPackageImpl implements UMLsecPackage {
	 ...
	 * @see UMLsec.UMLsecPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		initEClass(lanEClass, UMLsec.LAN.class, "LAN", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getLAN_Base_CommunicationPath(), theUMLPackage.getCommunicationPath(), null, "base_CommunicationPath", null, 1, 1, UMLsec.LAN.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getLAN_Base_Node(), theUMLPackage.getNode(), null, "base_Node", null, 1, 1, UMLsec.LAN.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
