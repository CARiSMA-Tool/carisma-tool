...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>encrypted</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link UMLsec.impl.encryptedImpl#getBase_CommunicationPath <em>Base Communication Path</em>}</li>
 * </ul>
 *
 * @generated
 */
public class encryptedImpl extends MinimalEObjectImpl.Container implements encrypted {
	/**
	...
	protected EClass eStaticClass() {
		return UMLsecPackage.Literals.ENCRYPTED;
	}
		...
		if (base_CommunicationPath != null && base_CommunicationPath.eIsProxy()) {
			...
			if (base_CommunicationPath != oldBase_CommunicationPath) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, UMLsecPackage.ENCRYPTED__BASE_COMMUNICATION_PATH, oldBase_CommunicationPath, base_CommunicationPath));
			}
		}
	...
	public void setBase_CommunicationPath(CommunicationPath newBase_CommunicationPath) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UMLsecPackage.ENCRYPTED__BASE_COMMUNICATION_PATH, oldBase_CommunicationPath, base_CommunicationPath));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case UMLsecPackage.ENCRYPTED__BASE_COMMUNICATION_PATH:
