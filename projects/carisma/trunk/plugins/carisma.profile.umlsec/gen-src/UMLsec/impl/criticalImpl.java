 ...
 * </p>
 * <ul>
 *   <li>{@link UMLsec.impl.criticalImpl#getSecrecy <em>Secrecy</em>}</li>
 *   <li>{@link UMLsec.impl.criticalImpl#getIntegrity <em>Integrity</em>}</li>
 *   <li>{@link UMLsec.impl.criticalImpl#getHigh <em>High</em>}</li>
 *   <li>{@link UMLsec.impl.criticalImpl#getBase_Class <em>Base Class</em>}</li>
 *   <li>{@link UMLsec.impl.criticalImpl#getBase_Component <em>Base Component</em>}</li>
 *   <li>{@link UMLsec.impl.criticalImpl#getFresh <em>Fresh</em>}</li>
 *   <li>{@link UMLsec.impl.criticalImpl#getAuthenticity <em>Authenticity</em>}</li>
 *   <li>{@link UMLsec.impl.criticalImpl#getBase_InstanceSpecification <em>Base Instance Specification</em>}</li>
 *   <li>{@link UMLsec.impl.criticalImpl#getBase_Classifier <em>Base Classifier</em>}</li>
 *   <li>{@link UMLsec.impl.criticalImpl#getPrivacy <em>Privacy</em>}</li>
 * </ul>
 *
 * @generated
 */
