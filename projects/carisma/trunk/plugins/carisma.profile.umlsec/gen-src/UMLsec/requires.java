 ...
 * </p>
 * <ul>
 *   <li>{@link UMLsec.requires#getBase_Action <em>Base Action</em>}</li>
 *   <li>{@link UMLsec.requires#getActions <em>Actions</em>}</li>
 * </ul>
 *
 * @see UMLsec.UMLsecPackage#getrequires()
 * @model
 * @generated
 */
public interface requires extends EObject {
	 ...
	 * @see UMLsec.UMLsecPackage#getrequires_Base_Action()
	...
	/**
	 * Sets the value of the '{@link UMLsec.requires#getBase_Action <em>Base Action</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see UMLsec.UMLsecPackage#getrequires_Actions()
	 * @model required="true" ordered="false"
	 * @generated
	 */
