 ...
 * </p>
 * <ul>
 *   <li>{@link UMLsec.LAN#getBase_CommunicationPath <em>Base Communication Path</em>}</li>
 *   <li>{@link UMLsec.LAN#getBase_Node <em>Base Node</em>}</li>
 * </ul>
 *
 * @see UMLsec.UMLsecPackage#getLAN()
 * @model
 * @generated
 */
public interface LAN extends EObject {
	 ...
	 * @see UMLsec.UMLsecPackage#getLAN_Base_CommunicationPath()
	...
	/**
	 * Sets the value of the '{@link UMLsec.LAN#getBase_CommunicationPath <em>Base Communication Path</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see UMLsec.UMLsecPackage#getLAN_Base_Node()
	 * @model required="true" ordered="false"
	 * @generated
	 */
	Node getBase_Node();
	...
	/**
	 * Sets the value of the '{@link UMLsec.LAN#getBase_Node <em>Base Node</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
