 ...
 * </p>
 * <ul>
 *   <li>{@link UMLsec.wire#getBase_CommunicationPath <em>Base Communication Path</em>}</li>
 * </ul>
 *
 * @see UMLsec.UMLsecPackage#getwire()
 * @model
 * @generated
 */
public interface wire extends EObject {
	 ...
	 * @see UMLsec.UMLsecPackage#getwire_Base_CommunicationPath()
	...
	/**
	 * Sets the value of the '{@link UMLsec.wire#getBase_CommunicationPath <em>Base Communication Path</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
