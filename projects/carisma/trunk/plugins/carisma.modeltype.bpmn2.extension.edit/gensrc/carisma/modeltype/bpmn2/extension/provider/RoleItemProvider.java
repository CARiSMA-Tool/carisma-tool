...
/**
 * This is the item provider adapter for a {@link carisma.modeltype.bpmn2.extension.Role} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ExtensionPackage.Literals.ROLE__NAME,
				 true,
				 false,
				 false,
	...
	protected void addMemberPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Role_member_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Role_member_feature", "_UI_Role_type"),
				 ExtensionPackage.Literals.ROLE__MEMBER,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addSuperPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Role_super_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Role_super_feature", "_UI_Role_type"),
				 ExtensionPackage.Literals.ROLE__SUPER,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addSubPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Role_sub_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Role_sub_feature", "_UI_Role_type"),
				 ExtensionPackage.Literals.ROLE__SUB,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addConflictPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Role_conflict_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Role_conflict_feature", "_UI_Role_type"),
				 ExtensionPackage.Literals.ROLE__CONFLICT,
				 true,
				 false,
				 true,
				 null,
