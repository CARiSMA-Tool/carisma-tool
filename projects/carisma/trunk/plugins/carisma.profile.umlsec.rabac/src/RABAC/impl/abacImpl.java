 ...
 * </p>
 * <ul>
 *   <li>{@link RABAC.impl.abacImpl#getRoles <em>Roles</em>}</li>
 *   <li>{@link RABAC.impl.abacImpl#getRights <em>Rights</em>}</li>
 *   <li>{@link RABAC.impl.abacImpl#getRh <em>Rh</em>}</li>
 *   <li>{@link RABAC.impl.abacImpl#getSsd <em>Ssd</em>}</li>
 *   <li>{@link RABAC.impl.abacImpl#getBase_Class <em>Base Class</em>}</li>
 *   <li>{@link RABAC.impl.abacImpl#getDsd <em>Dsd</em>}</li>
 *   <li>{@link RABAC.impl.abacImpl#getAttributeFilters <em>Attribute Filters</em>}</li>
 * </ul>
 *
 * @generated
 */
