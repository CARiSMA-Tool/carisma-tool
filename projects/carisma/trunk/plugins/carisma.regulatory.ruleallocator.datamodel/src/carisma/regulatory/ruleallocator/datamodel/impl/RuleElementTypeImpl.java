 ...
 * <ul>
 *   <li>{@link carisma.regulatory.ruleallocator.datamodel.impl.RuleElementTypeImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RuleElementTypeImpl extends EObjectImpl implements RuleElementType {
	...
	protected EClass eStaticClass() {
		return DatamodelPackage.Literals.RULE_ELEMENT_TYPE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DatamodelPackage.RULE_ELEMENT_TYPE__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DatamodelPackage.RULE_ELEMENT_TYPE__NAME:
				return getName();
		}
