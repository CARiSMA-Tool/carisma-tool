...
/**
 * This is the item provider adapter for a {@link carisma.ocl.library.OclLibrary} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class OclLibraryItemProvider
		...
		this.itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)this.adapterFactory).getRootAdapterFactory(),
				 ...
				 LibraryPackage.Literals.OCL_LIBRARY__NAME,
				 true,
				 false,
				 false,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/OclLibrary"));
	}
	...
	public String getText(Object object) {
		String label = ((OclLibrary)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_OclLibrary_type") :
			getString("_UI_OclLibrary_type") + " " + label;
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(LibraryPackage.Literals.OCL_LIBRARY__OCL_EXPRESSIONS,
				 LibraryFactory.eINSTANCE.createOclExpression()));
	}
