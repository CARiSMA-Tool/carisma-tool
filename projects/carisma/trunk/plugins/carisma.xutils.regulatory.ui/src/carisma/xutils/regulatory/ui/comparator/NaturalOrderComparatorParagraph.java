...
/**
 * The Class NaturalOrderComparatorParagraph.
 */
public class NaturalOrderComparatorParagraph implements Comparator<Paragraph> {
    ...
    public static void main(String[] args) {
        String[] strings = new String[] { "17", "18", "1-20", "10-20",
        ...
        Collections.sort(scrambled, new NaturalOrderComparatorParagraph());
