...
/**
 * The Class NaturalOrderComparatorLaw.
 */
public class NaturalOrderComparatorLaw implements Comparator<Law> {
    ...
    public static void main(String[] args) {
        ...
        Collections.sort(scrambled, new NaturalOrderComparatorLaw());
