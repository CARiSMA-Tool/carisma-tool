...
/**
 * The Class NaturalOrderComparatorRule.
 */
public class NaturalOrderComparatorRule implements Comparator<Rule> {
    ...
    public static void main(String[] args) {
        ...
        Collections.sort(scrambled, new NaturalOrderComparatorRule());
