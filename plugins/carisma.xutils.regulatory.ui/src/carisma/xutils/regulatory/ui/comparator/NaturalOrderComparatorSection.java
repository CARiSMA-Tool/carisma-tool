...
/**
 * The Class NaturalOrderComparatorSection.
 */
public class NaturalOrderComparatorSection implements Comparator<Section> {
    ...
    public static void main(String[] args) {
        ...
        Collections.sort(scrambled, new NaturalOrderComparatorSection());
