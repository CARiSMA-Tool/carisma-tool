 ...
 * </ul>
 * <!-- end-user-doc -->
 * @see umlsec4ids.Umlsec4idsFactory
 * @model kind="package"
 *        annotation="http://www.eclipse.org/uml2/2.0.0/UML originalName='UMLsecumlsec4ids'"
 * @generated
 */
public interface Umlsec4idsPackage extends EPackage {
	 ...
	 * @generated
	 */
	String eNS_PREFIX = "UMLsecumlsec4ids";
	 ...
	 * @generated
	 */
	Umlsec4idsPackage eINSTANCE = umlsec4ids.impl.Umlsec4idsPackageImpl.init();

	/**
	 * The meta object id for the '{@link umlsec4ids.impl.basefreeImpl <em>basefree</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see umlsec4ids.impl.basefreeImpl
	 * @see umlsec4ids.impl.Umlsec4idsPackageImpl#getbasefree()
	 * @generated
	 */
	int BASEFREE = 0;
	...
	/**
	 * Returns the meta object for class '{@link umlsec4ids.basefree <em>basefree</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>basefree</em>'.
	 * @see umlsec4ids.basefree
	 * @generated
	 */
	EClass getbasefree();

	/**
	 * Returns the meta object for the reference '{@link umlsec4ids.basefree#getBase_Node <em>Base Node</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference '<em>Base Node</em>'.
	 * @see umlsec4ids.basefree#getBase_Node()
	 * @see #getbasefree()
	 * @generated
	 */
	...
	interface Literals {
		/**
		 * The meta object literal for the '{@link umlsec4ids.impl.basefreeImpl <em>basefree</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see umlsec4ids.impl.basefreeImpl
		 * @see umlsec4ids.impl.Umlsec4idsPackageImpl#getbasefree()
