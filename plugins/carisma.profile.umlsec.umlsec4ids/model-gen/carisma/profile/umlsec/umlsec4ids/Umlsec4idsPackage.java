...
public interface Umlsec4idsPackage extends EPackage {
	...
	/**
	 * The meta object id for the '{@link carisma.profile.umlsec.umlsec4ids.impl.baseImpl <em>base</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see carisma.profile.umlsec.umlsec4ids.impl.baseImpl
	 * @see carisma.profile.umlsec.umlsec4ids.impl.Umlsec4idsPackageImpl#getbase()
	 * @generated
	 */
	int BASE = 1;
	...
	/**
	 * The meta object id for the '{@link carisma.profile.umlsec.umlsec4ids.impl.trustImpl <em>trust</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see carisma.profile.umlsec.umlsec4ids.impl.trustImpl
	 * @see carisma.profile.umlsec.umlsec4ids.impl.Umlsec4idsPackageImpl#gettrust()
	 * @generated
	 */
	int TRUST = 2;
	...
	/**
	 * The meta object id for the '{@link carisma.profile.umlsec.umlsec4ids.impl.trustplusImpl <em>trustplus</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see carisma.profile.umlsec.umlsec4ids.impl.trustplusImpl
	 * @see carisma.profile.umlsec.umlsec4ids.impl.Umlsec4idsPackageImpl#gettrustplus()
	 * @generated
	 */
	int TRUSTPLUS = 3;
	 ...
	 * @ordered
	 */
	int TRUSTPLUS__BASE_NODE = 0;

	/**
	 * The number of structural features of the '<em>trustplus</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int TRUSTPLUS_FEATURE_COUNT = 1;

	/**
	 * The number of operations of the '<em>trustplus</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int TRUSTPLUS_OPERATION_COUNT = 0;
	...
	/**
	 * Returns the meta object for class '{@link carisma.profile.umlsec.umlsec4ids.base <em>base</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for the reference '{@link carisma.profile.umlsec.umlsec4ids.base#getBase_Node <em>Base Node</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference '<em>Base Node</em>'.
	 * @see carisma.profile.umlsec.umlsec4ids.base#getBase_Node()
	 * @see #getbase()
	 * @generated
	 */
	EReference getbase_Base_Node();

	/**
	 * Returns the meta object for class '{@link carisma.profile.umlsec.umlsec4ids.trust <em>trust</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for the reference '{@link carisma.profile.umlsec.umlsec4ids.trust#getBase_Node <em>Base Node</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference '<em>Base Node</em>'.
	 * @see carisma.profile.umlsec.umlsec4ids.trust#getBase_Node()
	 * @see #gettrust()
	 * @generated
	 */
	EReference gettrust_Base_Node();

	/**
	 * Returns the meta object for class '{@link carisma.profile.umlsec.umlsec4ids.trustplus <em>trustplus</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>trustplus</em>'.
	...
	/**
	 * Returns the meta object for the reference '{@link carisma.profile.umlsec.umlsec4ids.trustplus#getBase_Node <em>Base Node</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference '<em>Base Node</em>'.
	 * @see carisma.profile.umlsec.umlsec4ids.trustplus#getBase_Node()
	 * @see #gettrustplus()
	 * @generated
	 */
	...
	interface Literals {
		...
		/**
		 * The meta object literal for the '{@link carisma.profile.umlsec.umlsec4ids.impl.baseImpl <em>base</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see carisma.profile.umlsec.umlsec4ids.impl.baseImpl
		 * @see carisma.profile.umlsec.umlsec4ids.impl.Umlsec4idsPackageImpl#getbase()
		 ...
		 * @generated
		 */
		EReference BASE__BASE_NODE = eINSTANCE.getbase_Base_Node();

		/**
		 * The meta object literal for the '{@link carisma.profile.umlsec.umlsec4ids.impl.trustImpl <em>trust</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see carisma.profile.umlsec.umlsec4ids.impl.trustImpl
		 * @see carisma.profile.umlsec.umlsec4ids.impl.Umlsec4idsPackageImpl#gettrust()
		 ...
		 * @generated
		 */
		EReference TRUST__BASE_NODE = eINSTANCE.gettrust_Base_Node();

		/**
		 * The meta object literal for the '{@link carisma.profile.umlsec.umlsec4ids.impl.trustplusImpl <em>trustplus</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see carisma.profile.umlsec.umlsec4ids.impl.trustplusImpl
		 * @see carisma.profile.umlsec.umlsec4ids.impl.Umlsec4idsPackageImpl#gettrustplus()
		 * @generated
		 */
		EClass TRUSTPLUS = eINSTANCE.gettrustplus();
