...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>isolated</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link carisma.profile.umlsec.umlsec4ids.impl.isolatedImpl#getBase_Node <em>Base Node</em>}</li>
 * </ul>
 *
 * @generated
 */
public class isolatedImpl extends MinimalEObjectImpl.Container implements isolated {
	/**
	...
	protected EClass eStaticClass() {
		return Umlsec4idsPackage.Literals.ISOLATED;
	}
		...
		if (base_Node != null && base_Node.eIsProxy()) {
			...
			if (base_Node != oldBase_Node) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Umlsec4idsPackage.ISOLATED__BASE_NODE, oldBase_Node, base_Node));
			}
		}
		return base_Node;
	}
	...
	public void setBase_Node(Node newBase_Node) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Umlsec4idsPackage.ISOLATED__BASE_NODE, oldBase_Node, base_Node));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Umlsec4idsPackage.ISOLATED__BASE_NODE:
