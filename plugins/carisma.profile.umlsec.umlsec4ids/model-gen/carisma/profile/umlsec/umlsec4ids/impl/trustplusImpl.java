...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>trustplus</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link carisma.profile.umlsec.umlsec4ids.impl.trustplusImpl#getBase_Node <em>Base Node</em>}</li>
 * </ul>
 *
 * @generated
 */
public class trustplusImpl extends MinimalEObjectImpl.Container implements trustplus {
	/**
	...
	protected EClass eStaticClass() {
		return Umlsec4idsPackage.Literals.TRUSTPLUS;
	}
		...
		if (base_Node != null && base_Node.eIsProxy()) {
			...
			if (base_Node != oldBase_Node) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Umlsec4idsPackage.TRUSTPLUS__BASE_NODE, oldBase_Node, base_Node));
			}
		}
		return base_Node;
	}
	...
	public void setBase_Node(Node newBase_Node) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Umlsec4idsPackage.TRUSTPLUS__BASE_NODE, oldBase_Node, base_Node));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Umlsec4idsPackage.TRUSTPLUS__BASE_NODE:
