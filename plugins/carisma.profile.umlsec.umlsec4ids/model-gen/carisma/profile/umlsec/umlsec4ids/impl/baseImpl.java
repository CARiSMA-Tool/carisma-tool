 ...
 * </p>
 * <ul>
 *   <li>{@link carisma.profile.umlsec.umlsec4ids.impl.baseImpl#getBase_Node <em>Base Node</em>}</li>
 * </ul>
 *
 * @generated
 */
public class baseImpl extends MinimalEObjectImpl.Container implements base {
	...
	protected EClass eStaticClass() {
		return Umlsec4idsPackage.Literals.BASE;
	}
		...
		if (base_Node != null && base_Node.eIsProxy()) {
			...
			if (base_Node != oldBase_Node) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Umlsec4idsPackage.BASE__BASE_NODE, oldBase_Node, base_Node));
			}
		}
		return base_Node;
	}
	...
	public void setBase_Node(Node newBase_Node) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Umlsec4idsPackage.BASE__BASE_NODE, oldBase_Node, base_Node));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Umlsec4idsPackage.BASE__BASE_NODE:
