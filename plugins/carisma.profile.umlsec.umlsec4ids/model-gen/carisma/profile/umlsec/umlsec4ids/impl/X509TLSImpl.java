...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>X509TLS</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 ...
 * @generated
 */
public class X509TLSImpl extends MinimalEObjectImpl.Container implements X509TLS {
	/**
	...
	protected EClass eStaticClass() {
		return Umlsec4idsPackage.Literals.X509TLS;
	}
		...
		if (base_Node != null && base_Node.eIsProxy()) {
			...
			if (base_Node != oldBase_Node) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Umlsec4idsPackage.X509TLS__BASE_NODE, oldBase_Node, base_Node));
			}
		}
		return base_Node;
	}
	...
	public void setBase_Node(Node newBase_Node) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Umlsec4idsPackage.X509TLS__BASE_NODE, oldBase_Node, base_Node));
	}
