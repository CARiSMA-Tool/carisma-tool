 ...
 * </p>
 * <ul>
 *   <li>{@link carisma.profile.umlsec.issuernode#getBase_Node <em>Base Node</em>}</li>
 * </ul>
 *
 * @see carisma.profile.umlsec.UmlsecPackage#getissuernode()
...
public interface issuernode extends EObject {
	 ...
	 * @see carisma.profile.umlsec.UmlsecPackage#getissuernode_Base_Node()
	...
	/**
	 * Sets the value of the '{@link carisma.profile.umlsec.issuernode#getBase_Node <em>Base Node</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
