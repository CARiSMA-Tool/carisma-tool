...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>authorizedstatus</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link carisma.profile.umlsec.impl.authorizedstatusImpl#getPermission <em>Permission</em>}</li>
 *   <li>{@link carisma.profile.umlsec.impl.authorizedstatusImpl#getBase_State <em>Base State</em>}</li>
 * </ul>
 *
 * @generated
 */
...
public class authorizedstatusImpl extends MinimalEObjectImpl.Container implements authorizedstatus {
	 ...
	 * @generated
	 */
	protected authorizedstatusImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return UmlsecPackage.Literals.AUTHORIZEDSTATUS;
	}
	...
	public void setPermission(String newPermission) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UmlsecPackage.AUTHORIZEDSTATUS__PERMISSION, oldPermission, permission));
	}
	...
	public State getBase_State() {
		if (base_State != null && base_State.eIsProxy()) {
			...
			if (base_State != oldBase_State) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, UmlsecPackage.AUTHORIZEDSTATUS__BASE_STATE, oldBase_State, base_State));
			}
		}
		return base_State;
	}
	...
	public void setBase_State(State newBase_State) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UmlsecPackage.AUTHORIZEDSTATUS__BASE_STATE, oldBase_State, base_State));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case UmlsecPackage.AUTHORIZEDSTATUS__PERMISSION:
				return getPermission();
			case UmlsecPackage.AUTHORIZEDSTATUS__BASE_STATE:
