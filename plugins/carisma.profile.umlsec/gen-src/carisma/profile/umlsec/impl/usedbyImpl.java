...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>usedby</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link carisma.profile.umlsec.impl.usedbyImpl#getUser <em>User</em>}</li>
 *   <li>{@link carisma.profile.umlsec.impl.usedbyImpl#getBase_Action <em>Base Action</em>}</li>
 *   <li>{@link carisma.profile.umlsec.impl.usedbyImpl#getBase_State <em>Base State</em>}</li>
 * </ul>
 *
 * @generated
 */
public class usedbyImpl extends MinimalEObjectImpl.Container implements usedby {
	/**
	...
	protected EClass eStaticClass() {
		return UmlsecPackage.Literals.USEDBY;
	}
		...
		if (base_Action != null && base_Action.eIsProxy()) {
			...
			if (base_Action != oldBase_Action) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, UmlsecPackage.USEDBY__BASE_ACTION, oldBase_Action, base_Action));
			}
		}
		return base_Action;
	}
	...
	public void setBase_Action(Action newBase_Action) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UmlsecPackage.USEDBY__BASE_ACTION, oldBase_Action, base_Action));
	}
	...
	public State getBase_State() {
		if (base_State != null && base_State.eIsProxy()) {
			...
			if (base_State != oldBase_State) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, UmlsecPackage.USEDBY__BASE_STATE, oldBase_State, base_State));
			}
		}
		return base_State;
	}
	...
	public void setBase_State(State newBase_State) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UmlsecPackage.USEDBY__BASE_STATE, oldBase_State, base_State));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case UmlsecPackage.USEDBY__USER:
				return getUser();
			case UmlsecPackage.USEDBY__BASE_ACTION:
				if (resolve) return getBase_Action();
				return basicGetBase_Action();
			case UmlsecPackage.USEDBY__BASE_STATE:
