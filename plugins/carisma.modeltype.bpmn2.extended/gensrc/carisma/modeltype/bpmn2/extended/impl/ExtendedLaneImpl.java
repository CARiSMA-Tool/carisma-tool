 ...
 * <ul>
 *   <li>{@link carisma.modeltype.bpmn2.extended.impl.ExtendedLaneImpl#getRole <em>Role</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ExtendedLaneImpl extends LaneImpl implements ExtendedLane {
	/**
	...
	protected EClass eStaticClass() {
		return ExtendedPackage.Literals.EXTENDED_LANE;
	}
	...
	public EList<Role> getRole() {
		if (role == null) {
			role = new EObjectResolvingEList<Role>(Role.class, this, ExtendedPackage.EXTENDED_LANE__ROLE);
		}
		return role;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ExtendedPackage.EXTENDED_LANE__ROLE:
				return getRole();
		}
