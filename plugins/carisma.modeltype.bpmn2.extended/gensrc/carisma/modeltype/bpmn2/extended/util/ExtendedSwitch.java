 ...
 * <!-- end-user-doc -->
 * @see carisma.modeltype.bpmn2.extended.ExtendedPackage
 * @generated
 */
public class ExtendedSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ExtendedPackage.EXTENDED_DOCUMENT_ROOT: {
				ExtendedDocumentRoot extendedDocumentRoot = (ExtendedDocumentRoot)theEObject;
				T result = caseExtendedDocumentRoot(extendedDocumentRoot);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ExtendedPackage.EXTENDED_PROCESS: {
				ExtendedProcess extendedProcess = (ExtendedProcess)theEObject;
				T result = caseExtendedProcess(extendedProcess);
				if (result == null) result = caseProcess(extendedProcess);
				if (result == null) result = caseCallableElement(extendedProcess);
				if (result == null) result = caseFlowElementsContainer(extendedProcess);
				if (result == null) result = caseRootElement(extendedProcess);
				if (result == null) result = caseBaseElement(extendedProcess);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ExtendedPackage.EXTENDED_TASK: {
				ExtendedTask extendedTask = (ExtendedTask)theEObject;
				T result = caseExtendedTask(extendedTask);
				if (result == null) result = caseTask(extendedTask);
				if (result == null) result = caseActivity(extendedTask);
				if (result == null) result = caseInteractionNode(extendedTask);
				if (result == null) result = caseFlowNode(extendedTask);
				if (result == null) result = caseFlowElement(extendedTask);
				if (result == null) result = caseBaseElement(extendedTask);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ExtendedPackage.EXTENDED_LANE: {
				ExtendedLane extendedLane = (ExtendedLane)theEObject;
				T result = caseExtendedLane(extendedLane);
				if (result == null) result = caseLane(extendedLane);
				if (result == null) result = caseBaseElement(extendedLane);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	 ...
	 * @generated
	 */
	public T caseExtendedDocumentRoot(ExtendedDocumentRoot object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseExtendedProcess(ExtendedProcess object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseExtendedTask(ExtendedTask object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseExtendedLane(ExtendedLane object) {
		return null;
	}
