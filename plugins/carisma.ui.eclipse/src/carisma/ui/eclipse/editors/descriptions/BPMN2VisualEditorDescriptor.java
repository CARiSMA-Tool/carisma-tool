 ...
 */
@Deprecated
public class BPMN2VisualEditorDescriptor extends AbstractEditorDescriptor {
	
	/**
	 * Getter for the EditorDescriptor name.
	 * @return the name of the descriptor
	 */
	public static final String NAME = "BPMN_MODELER";
	...
	public final String getId() {
		return Constants.BPMN2_MODELER_EDITOR_ID;
	}
