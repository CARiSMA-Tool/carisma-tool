 ...
 * 
 * Extends the AbstractEditorDescriptor.
 */
@Deprecated
public class UmlEditorDescriptor extends AbstractEditorDescriptor {
	
	/**
	 * EditorDescriptor name.
	 */
	public static final String NAME = "UML Model Editor";
	
	//########################################################################################
	/**
	 * Constructor.
	 */
	public UmlEditorDescriptor() {
