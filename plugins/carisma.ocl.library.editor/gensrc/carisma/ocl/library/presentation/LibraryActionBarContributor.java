...
public class LibraryActionBarContributor
	...
	protected IAction showPropertiesViewAction =
		new Action(OclEditorPlugin.INSTANCE.getString("_UI_ShowPropertiesView_menu_item")) {
			@Override
			public void run() {
				try {
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(OclEditorPlugin.INSTANCE.getString("_UI_LibraryEditor_menu"), "carisma.ocl.libraryMenuID");
