...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Provider Connector</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link carisma.profile.umlsec.extension4ids.impl.ProviderConnectorImpl#getBase_Lifeline <em>Base Lifeline</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ProviderConnectorImpl extends MinimalEObjectImpl.Container implements ProviderConnector {
	/**
	 ...
	 * @generated
	 */
	protected ProviderConnectorImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return Extension4idsPackage.Literals.PROVIDER_CONNECTOR;
	}
		...
		if (base_Lifeline != null && base_Lifeline.eIsProxy()) {
			...
			if (base_Lifeline != oldBase_Lifeline) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Extension4idsPackage.PROVIDER_CONNECTOR__BASE_LIFELINE, oldBase_Lifeline, base_Lifeline));
			}
		}
	...
	public void setBase_Lifeline(Lifeline newBase_Lifeline) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Extension4idsPackage.PROVIDER_CONNECTOR__BASE_LIFELINE, oldBase_Lifeline, base_Lifeline));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Extension4idsPackage.PROVIDER_CONNECTOR__BASE_LIFELINE:
