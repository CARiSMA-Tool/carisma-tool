 ...
 * </p>
 * <ul>
 *   <li>{@link mltop10.impl.integrityImpl#getBase_CommunicationPath <em>Base Communication Path</em>}</li>
 * </ul>
 *
 * @generated
 */
public class integrityImpl extends MinimalEObjectImpl.Container implements integrity {
	...
	protected EClass eStaticClass() {
		return Mltop10Package.Literals.INTEGRITY;
	}
		...
		if (base_CommunicationPath != null && base_CommunicationPath.eIsProxy()) {
			...
			if (base_CommunicationPath != oldBase_CommunicationPath) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Mltop10Package.INTEGRITY__BASE_COMMUNICATION_PATH, oldBase_CommunicationPath, base_CommunicationPath));
			}
		}
	...
	public void setBase_CommunicationPath(CommunicationPath newBase_CommunicationPath) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Mltop10Package.INTEGRITY__BASE_COMMUNICATION_PATH, oldBase_CommunicationPath, base_CommunicationPath));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Mltop10Package.INTEGRITY__BASE_COMMUNICATION_PATH:
