...
/**
 * This is the item provider adapter for a {@link carisma.modeltype.bpmn2.extension.TaskSet} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TaskSetItemProvider
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addSelectedTasksPropertyDescriptor(object);
		}
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ExtensionPackage.Literals.TASK_SET__NAME,
				 true,
				 false,
				 false,
	...
	/**
	 * This adds a property descriptor for the Selected Tasks feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addSelectedTasksPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TaskSet_selectedTasks_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TaskSet_selectedTasks_feature", "_UI_TaskSet_type"),
				 ExtensionPackage.Literals.TASK_SET__SELECTED_TASKS,
				 true,
				 false,
				 true,
				 null,
