...
/**
 * This is the item provider adapter for a {@link carisma.modeltype.bpmn2.extension.Task} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ExtensionPackage.Literals.TASK__NAME,
				 true,
				 false,
				 false,
	...
	protected void addWorkItemPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Task_workItem_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Task_workItem_feature", "_UI_Task_type"),
				 ExtensionPackage.Literals.TASK__WORK_ITEM,
				 true,
				 false,
				 true,
				 null,
