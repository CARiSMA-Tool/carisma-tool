...
/**
 * This is the item provider adapter for a {@link carisma.modeltype.bpmn2.extension.Performer} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PerformerItemProvider
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addWorkItemPropertyDescriptor(object);
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ExtensionPackage.Literals.PERFORMER__NAME,
				 true,
				 false,
				 false,
	...
	/**
	 * This adds a property descriptor for the Work Item feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addWorkItemPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Performer_workItem_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Performer_workItem_feature", "_UI_Performer_type"),
				 ExtensionPackage.Literals.PERFORMER__WORK_ITEM,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addRolePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Performer_role_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Performer_role_feature", "_UI_Performer_type"),
				 ExtensionPackage.Literals.PERFORMER__ROLE,
				 true,
				 false,
				 true,
				 null,
