...
/**
 * This is the item provider adapter for a {@link carisma.modeltype.bpmn2.extension.Lane} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ExtensionPackage.Literals.LANE__NAME,
				 true,
				 false,
				 false,
	...
	protected void addRolePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Lane_role_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Lane_role_feature", "_UI_Lane_type"),
				 ExtensionPackage.Literals.LANE__ROLE,
				 true,
				 false,
				 true,
				 null,
