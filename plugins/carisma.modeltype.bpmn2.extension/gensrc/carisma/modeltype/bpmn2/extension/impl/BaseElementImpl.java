 ...
 * <ul>
 *   <li>{@link carisma.modeltype.bpmn2.extension.impl.BaseElementImpl#getId <em>Id</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class BaseElementImpl extends EObjectImpl implements BaseElement {
	...
	protected EClass eStaticClass() {
		return ExtensionPackage.Literals.BASE_ELEMENT;
	}
	...
	public void setId(String newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExtensionPackage.BASE_ELEMENT__ID, oldId, id));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ExtensionPackage.BASE_ELEMENT__ID:
				return getId();
		}
