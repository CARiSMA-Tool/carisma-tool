 ...
 * <ul>
 *   <li>{@link carisma.modeltype.bpmn2.extension.impl.LaneImpl#getName <em>Name</em>}</li>
 *   <li>{@link carisma.modeltype.bpmn2.extension.impl.LaneImpl#getRole <em>Role</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class LaneImpl extends BaseElementImpl implements Lane {
	...
	protected EClass eStaticClass() {
		return ExtensionPackage.Literals.LANE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExtensionPackage.LANE__NAME, oldName, name));
	}
	...
	public EList<Role> getRole() {
		if (role == null) {
			role = new EObjectResolvingEList<Role>(Role.class, this, ExtensionPackage.LANE__ROLE);
		}
		return role;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ExtensionPackage.LANE__NAME:
				return getName();
			case ExtensionPackage.LANE__ROLE:
				return getRole();
		}
