/**
 * CooccurrencesSoapBindingStub.java
 *
...
public class CooccurrencesSoapBindingStub extends org.apache.axis.client.Stub implements Cooccurrences {
	...
	private static void initOperationDesc1() {
		...
		oper.addParameter(new javax.xml.namespace.QName("urn:Cooccurrences", "objRequestParameters"), new javax.xml.namespace.QName("urn:Cooccurrences", "RequestParameter"), RequestParameter.class, org.apache.axis.description.ParameterDesc.IN, false, false);
		oper.setReturnType(new javax.xml.namespace.QName("urn:Cooccurrences", "ResponseParameter"));
		oper.setReturnClass(ResponseParameter.class);
		oper.setReturnQName(new javax.xml.namespace.QName("urn:Cooccurrences", "executeReturn"));
		...
		oper.setReturnQName(new javax.xml.namespace.QName("urn:Cooccurrences", "pingReturn"));
		oper.setStyle(org.apache.axis.constants.Style.WRAPPED);
		oper.setUse(org.apache.axis.constants.Use.LITERAL);
		operations[1] = oper;
	...
	public CooccurrencesSoapBindingStub() throws org.apache.axis.AxisFault {
		this(null);
	}

	public CooccurrencesSoapBindingStub(final java.net.URL endpointURL, final javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
		this(service);
		super.cachedEndpoint = endpointURL;
	}

	public CooccurrencesSoapBindingStub(final javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
		if (service == null) {
		...
		qName = new javax.xml.namespace.QName("urn:Cooccurrences", "DataMatrix");
		cachedSerQNames.add(qName);
		...
		qName = new javax.xml.namespace.QName("urn:Cooccurrences", "RequestParameter");
		cachedSerQNames.add(qName);
		...
		qName = new javax.xml.namespace.QName("urn:Cooccurrences", "ResponseParameter");
		cachedSerQNames.add(qName);
	...
	public final ResponseParameter execute(final RequestParameter objRequestParameters) throws java.rmi.RemoteException {
		...
		call.setOperationName(new javax.xml.namespace.QName("urn:Cooccurrences", "execute"));
	...
	public final java.lang.String ping() throws java.rmi.RemoteException {
		...
		call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
		call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
		call.setOperationName(new javax.xml.namespace.QName("urn:Cooccurrences", "ping"));
